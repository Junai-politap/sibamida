...
<?php $component = App\View\Components\Button\BackButton::resolve(['url' => 'staff-administrasi/kategori'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('staff-administrasi/kategori', $kategori->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputText">Nama Kategori</label>
                                    <input type="text" class="form-control" value="<?php echo e($kategori->nama_kategori); ?>"
                                        name="nama_kategori">
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/kategori/edit.blade.php ENDPATH**/ ?>
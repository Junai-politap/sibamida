...
<?php endif; ?>
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="<?php echo e(url("admin/bangunan/delete-riwayat/$riwayat->id")); ?>"
                        ...
                        <div class="modal fade" id="modal-edit<?php echo e($riwayat->id); ?>">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(url('admin/bangunan/update-riwayat', $riwayat->id)); ?>" method="POST">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(url('admin/bangunan/riwayat')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/admin/bangunan/show.blade.php ENDPATH**/ ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="btn-group float-right mb-10">
                                ...
                                <a href="<?php echo e(url('staff-administrasi/peralatan-export')); ?>" class="btn btn-success"> <span class="fa fa-file-export"></span> Export Excel</a>
                            <a href="<?php echo e(url('staff-administrasi/master/peralatan-mesin/create')); ?>" class="btn btn-primary float-right mb-10"> <span
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php if( Auth::guard('staff')->user()->id_opd == $peralatan->id_opd): ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <?php if (isset($component)) { $__componentOriginaldf05ec2d539ccc47939751d83314ef26 = $component; } ?>
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'staff-administrasi/master/peralatan-mesin','id' => ''.e($peralatan->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'staff-administrasi/master/peralatan-mesin','id' => ''.e($peralatan->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'staff-administrasi/master/peralatan-mesin','id' => ''.e($peralatan->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(url('staff-administrasi/peralatan-download-laporan')); ?>" method="get">
                <?php echo csrf_field(); ?>
...
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/peralatan-mesin/index.blade.php ENDPATH**/ ?>
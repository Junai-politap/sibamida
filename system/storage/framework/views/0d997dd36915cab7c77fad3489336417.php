...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('opd/master/peralatan-mesin', $peralatan->id)); ?>" method="POST"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Masukkan Nama Barang" value="<?php echo e($peralatan->nama_barang); ?>"
...
<?php endif; ?>
<?php /**PATH D:\Github\sibamida\system\resources\views/opd/peralatan/edit.blade.php ENDPATH**/ ?>
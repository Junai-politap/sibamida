                        ...
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo e(url("edit-prodi/$prodi->id")); ?>" class="btn btn-warning"><span
                                            class="fa fa-edit"></span> Edit</a>

                                    <a href="<?php echo e(url("delete-prodi/$prodi->id")); ?>" class="btn btn-danger"><span
                                            class="fa fa-trash"></span> Hapus</a>
                                </div>
                            </td>
                            <td class="text-center"><?php echo e($prodi->nama); ?></td>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo e(url('store-prodi')); ?>" method="POST"
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/admin/prodi/index.blade.php ENDPATH**/ ?>
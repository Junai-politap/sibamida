...
<?php endif; ?>
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="<?php echo e(url("staff-administrasi/tanah/delete-riwayat/$riwayat->id")); ?>"
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(url('staff-administrasi/tanah/riwayat')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/tanah/show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Informatika Dalam Angka Prodi - '); ?>
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layout.home.page-title', [
        'page_title' => 'Informatika Dalam Angka',
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-5">
                    <h3 class="section-title-underline">Data Peminat</h3>
                    <canvas id="peminat" width="400" height="250"></canvas>
                </div>
                <div class="col-md-6 mb-5">
                    <h3 class="section-title-underline">Data Lulusan</h3>
                    <canvas id="lulusan" width="400" height="250"></canvas>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-6 mb-5">
                    <h3 class="section-title-underline">Data Mahasiswa</h3>
                    <canvas id="mahasiswa" width="400" height="250"></canvas>
                </div>
                <div class="col-md-6 mb-5">
                    <h3 class="section-title-underline">Rata-Rata IPK</h3>
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\informatika\system\resources\views/home/akademik/informatika-dalam-angka.blade.php ENDPATH**/ ?>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo e(url('admin/admin/create')); ?>" class="btn btn-primary float-right mb-10"> <span
                    ...
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $list_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <?php if (isset($component)) { $__componentOriginaldf05ec2d539ccc47939751d83314ef26 = $component; } ?>
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'admin/admin','id' => ''.e($admin->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'admin/admin','id' => ''.e($admin->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'admin/admin','id' => ''.e($admin->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                        ...
                                        <td class="text-center"><?php echo e($admin->nama); ?></td>
                                        <td class="text-center"><?php echo e($admin->username); ?></td>
                                        <td class="text-center" style="width: 20%">
                                            <img src="<?php echo e(url("public/$admin->poto")); ?>" style="width:30%; height:30%;" onerror="this.src='https://bootdey.com/img/Content/avatar/avatar7.png';">
                                        </td>
                                    </tr>
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/admin/admin/index.blade.php ENDPATH**/ ?>
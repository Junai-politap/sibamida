...
<?php $component->withAttributes([]); ?>
        ...
        <div class="slider-one">
            <div class="slider-one__carousel thm__owl-dot-1 owl-carousel owl-theme thm__owl-carousel"
                ...
                <div class="item slider-one__slide-1"
                    style="background-image: url(<?php echo e(url('public/web')); ?>/assets/images/background/slide-bg-1-1.jpg);">
                    <div class="container">
                        <div class="slider-one__content text-center">
                            ...
                            <a href="courses.html" class="thm-btn anim-elm">View all courses</a>
                        </div>
                    </div>
                </div>
                <div class="item slider-one__slide-2"
                    style="background-image: url(<?php echo e(url('public/web')); ?>/assets/images/background/slide-bg-1-2.jpg);">
                    <div class="container">
                        <div class="slider-one__content text-center">
                            <p class="anim-elm">Discover Scuba Diving in New York</p>
    ...
    <section class="cta-two">
        <div class="cta-two__bg"
            style="background-image: url(<?php echo e(url('public/web')); ?>/assets/images/background/footer-bg-1-1.jpg);"></div>

        <div class="container">
            <img src="<?php echo e(url('public/web')); ?>/assets/images/shapes/slide-ribbon-1-1.png" alt=""
                class="cta-two__moc">
            ...
            <div class="cta-two__btn-block">
                <a href="contact.html" class="thm-btn cta-two__btn">Start with us now</a>
            </div>
        </div>
    </section>
    ...
    <section class="service-one">
        ...
        <div class="container">
            <div class="block-title text-center">
                <img src="<?php echo e(url('public/web')); ?>/assets/images/shapes/sec-line-1.png" alt="">
                    ...
                    <div class="course-one__single">
                        <div class="course-one__image">
                            ...
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-1.jpg"
                                    alt="">
                ...
                <div class="item">
                    <div class="course-one__single">
                        <div class="course-one__image">
                            ...
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-2.jpg"
                                    alt="">
                                <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="course-one__single">
                        <div class="course-one__image">
                            ...
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-3.jpg"
                                    alt="">
                                <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="course-one__single">
                        <div class="course-one__image">
                            <a href="course-details.html" class="course-one__cat">advanced</a>
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-4.jpg"
                                    alt="">
                                <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="course-one__single">
                        <div class="course-one__image">
                            <a href="course-details.html" class="course-one__cat">advanced</a>
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-5.jpg"
                                    alt="">
                                <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="course-one__single">
                        <div class="course-one__image">
                            <a href="course-details.html" class="course-one__cat">Professional</a>
                            <div class="course-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/courses/course-1-6.jpg"
                                    alt="">
                                <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
    ...
    <div class="cta-three__feature"></div>
                    ...
                    <div class="blog-one__single">
                        <div class="blog-one__image">
                            ...
                            <div class="blog-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/blog/blog-1-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="blog-one__single">
                        <div class="blog-one__image">
                            <a href="news-details.html" class="blog-one__date">02 Jan, 2020</a>
                            <div class="blog-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/blog/blog-1-2.jpg" alt="">
                                <a href="news-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                        <div class="blog-one__content">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="blog-one__single">
                        <div class="blog-one__image">
                            <a href="news-details.html" class="blog-one__date">02 Jan, 2020</a>
                            <div class="blog-one__image-inner">
                                <img src="<?php echo e(url('public/web')); ?>/assets/images/blog/blog-1-3.jpg" alt="">
                                <a href="news-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                            </div>
                        </div>
                        <div class="blog-one__content">
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/web/index.blade.php ENDPATH**/ ?>
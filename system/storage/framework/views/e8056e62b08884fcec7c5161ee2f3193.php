            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo e(url('admin/pegawai/create')); ?>" class="btn btn-primary float-right mb-10"> <span
...
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'admin/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'admin/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'admin/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                        ...
                                        <td class="text-left">
                                            ...
                                            <br>
                                           NIK : <?php echo e($pegawai->nik); ?>


                                        </td>
                                        <td class=""><?php echo e($pegawai->nama); ?></td>
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/admin/pegawai/index.blade.php ENDPATH**/ ?>
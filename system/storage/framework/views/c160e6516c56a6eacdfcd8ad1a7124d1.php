...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('admin/master/tanah', $tanah->id)); ?>" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_opd" class="form-control">
                                                <?php $__currentLoopData = $list_opd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if($opd->id == $tanah->id_opd): ?> selected <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/admin/tanah/edit.blade.php ENDPATH**/ ?>
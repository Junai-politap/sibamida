                    ...
                    <div class="widget"><br>
                        <header class="widget-header"><br>
                            <h4 class="widget-title">
                                <?php $__currentLoopData = $list_bagian->where('id', '96ae2422-0023-45bd-87b2-7ec4d65b027f'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bagian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="container">
                            <form action="<?php echo e(url('store-form-V')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input name="id_mahasiswa" value="<?php echo e($mahasiswa->id); ?>" type="hidden">

                                <?php $__currentLoopData = $list_soal->where('id_bagian', '96ae2422-0023-45bd-87b2-7ec4d65b027f'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="form-group" style="margin-left: 2%">
                                                                <div class="radio">
                                                                    <input type="radio"
                                                                        ...
                                                                        class="form-check-input" value="<?php echo e($jawaban->id); ?>" required>
...
<?php echo $__env->make('template.mahasiswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/mahasiswa/tracer-study-form-v.blade.php ENDPATH**/ ?>
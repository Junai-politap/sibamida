                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center title">
                            <strong>Laporan Assest Jembatan dan Jalan</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="footer">
                            <a href="" class="btn btn-primary col-md-12"><i class="fa fa-print"> Cetak
                                    Laporan</i> </a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center title">
                            <strong>Laporan Assest Peralatan dan Mesin</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center title">
                            <strong>Laporan Assest Bangunan</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center title">
                            <strong>Laporan Assest Tanah</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
<?php endif; ?>
<?php /**PATH D:\Github\sibamida\system\resources\views/opd/laporan/index.blade.php ENDPATH**/ ?>
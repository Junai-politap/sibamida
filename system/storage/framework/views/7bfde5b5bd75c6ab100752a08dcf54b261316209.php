							...
							<div class="timeline-panel credits  anim animate fadeInLeft">
								<ul class="timeline-panel-ul">
									<div class="lefting-wrap">
										<li class="img-wraping"><a href="#"><img src="<?php echo e(url("public/$akreditasi->file")); ?>" class="img-responsive" alt="user-image" /></a></li>
									</div>
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\informatika\system\resources\views/home/akademik/akreditasi.blade.php ENDPATH**/ ?>
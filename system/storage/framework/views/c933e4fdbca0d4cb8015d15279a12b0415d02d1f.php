        ...
        <div class="container">
            <div class="row">
                ...
                <?php $__currentLoopData = $list_pelayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelayanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($pelayanan->id_jenis_pelayanan == $jenis_pelayanan->id_jenis_pelayanan): ?>
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\informatika\system\resources\views/home/pelayanan/show-pelayanan.blade.php ENDPATH**/ ?>
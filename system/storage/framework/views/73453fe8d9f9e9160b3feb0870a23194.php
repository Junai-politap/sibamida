                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo e(url('opd/pegawai/create')); ?>" class="btn btn-primary float-right mb-10"> <span
...
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'opd/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'opd/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'opd/pegawai','id' => ''.e($pegawai->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                            ...
                                            <td>
                                                <img src="<?php echo e(url("public/$pegawai->pegawai")); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sibamida\system\resources\views/opd/pegawai/index.blade.php ENDPATH**/ ?>
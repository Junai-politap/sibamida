                    ...
                    <?php $__currentLoopData = $list_soal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo e(url("show-soal/$soal->id")); ?>" class="btn btn-info"><span
                            ...
                            <td class="text-center"><?php echo e($soal->nama_soal); ?></td>
                            <td class="text-center">
                                <img src="<?php echo e(url("public/$soal->gambar")); ?>" alt=""
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/admin/soal/index.blade.php ENDPATH**/ ?>
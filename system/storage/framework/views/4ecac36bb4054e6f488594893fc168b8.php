                                    ...
                                    <div class="modal fade" id="modal-edit<?php echo e($kondisi->id); ?>">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(url('staff-administrasi/kondisi', $kondisi->id)); ?>" method="POST">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('staff-administrasi/kondisi')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/staff-administrasi/kondisi/index.blade.php ENDPATH**/ ?>
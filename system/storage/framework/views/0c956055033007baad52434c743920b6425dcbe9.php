...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="<?php echo e(url('store-mahasiswa')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/admin/mahasiswa/create.blade.php ENDPATH**/ ?>
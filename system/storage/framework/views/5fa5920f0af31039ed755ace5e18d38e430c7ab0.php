                    ...
                    <?php $__currentLoopData = $list_dosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo e(url("show-berita/$dosen->id")); ?>" class="btn btn-info"><span
                                            class="fa fa-info"></span> Lihat</a>

                                    <a href="<?php echo e(url("edit-berita/$dosen->id")); ?>" class="btn btn-warning"><span
                                            class="fa fa-edit"></span> Edit</a>

                                    <a href="<?php echo e(url("delete-berita/$dosen->id")); ?>" class="btn btn-danger"><span
                                            class="fa fa-trash"></span> Hapus</a>
                                </div>
                            </td>
                            <td class="">
                               NIM : <?php echo e($dosen->nim); ?> <br>
                               NIK : <?php echo e($dosen->nik); ?>

                            </td>
                            <td class="text-center"><?php echo e($dosen->nama); ?></td>
                            <td class="text-center"><?php echo e($dosen->jenis_kelamin); ?></td>
                        </tr>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/admin/dosen/index.blade.php ENDPATH**/ ?>
                ...
                <div class="col-lg-7">
                    <div class="page-title">
                        ...
                        <ul class="breadcrumbs-link">
                            ...
                            <li class="active"><a href="<?php echo e(url("peralatan/$peralatan->id_opd")); ?>"> Data Aset peralatan dan
                                    Jalan </a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="entry-content" style="text-align: center">
                                    ...
                                    <div class="post-meta">
                                        <ul>
                                            <li>
                                                <span>
                                                    <i class="far fa-check"></i><?php echo e($peralatan->kategori->nama_kategori); ?>
...
<script src="https://cdn.rawgit.com/davidshimjs/qrcodejs/gh-pages/qrcode.min.js"></script>
    ...
    </script><?php /**PATH D:\GitHub\sibamida\system\resources\views/web/show-peralatan.blade.php ENDPATH**/ ?>
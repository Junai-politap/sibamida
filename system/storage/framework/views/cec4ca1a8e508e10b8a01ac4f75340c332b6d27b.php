        ...
        <div class="container">
            ...
            <div class="row">
                <?php $__currentLoopData = $list_fasilitas->where('jenis_fasilitas', 'Workspace'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url("show-workshop/$fasilitas->id")); ?>">
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/home/fasilitas/workspace.blade.php ENDPATH**/ ?>
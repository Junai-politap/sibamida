                    ...
                    <tr>
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <a href="<?php echo e(url("delete-slide/$slide->id")); ?>" class="btn btn-danger"><span
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/admin/slide/index.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('staff-administrasi/master/jembatan-jalan')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                <input type="text" name="id_opd" value="<?php echo e(Auth::guard('staff')->user()->id_opd); ?>" class="form-control" hidden>
                                    <input type="text" name="id_pegawai" value="<?php echo e(Auth::guard('staff')->user()->id); ?>" class="form-control" hidden>
                                <div class="row">
                                    <div class="col-md-6">
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/jembatan-jalan/create.blade.php ENDPATH**/ ?>
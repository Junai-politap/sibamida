                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <a href="<?php echo e(url("admin/kategori/delete/$kategori->id")); ?>"
                                    ...
                                    <div class="modal fade" id="modal-edit<?php echo e($kategori->id); ?>">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(url('admin/kategori', $kategori->id)); ?>" method="POST">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select name="id_opd" class="form-control">
                                                                        <?php $__currentLoopData = $list_opd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option
                                                                                <?php if($opd->id == $kategori->id_opd): ?> selected <?php endif; ?>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('admin/kategori')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/admin/kategori/index.blade.php ENDPATH**/ ?>
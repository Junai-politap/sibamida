...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('opd/kategori')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
<?php endif; ?>
<?php /**PATH D:\Github\sibamida\system\resources\views/opd/kategori/create.blade.php ENDPATH**/ ?>
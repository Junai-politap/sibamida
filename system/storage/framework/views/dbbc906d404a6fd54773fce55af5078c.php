...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('admin/master/bangunan')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Masukkan Kelurahan Desa" name="kelurahan_desa">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/admin/bangunan/create.blade.php ENDPATH**/ ?>
                ...
                <?php $__currentLoopData = $list_akreditasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $akreditasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="<?php echo e(url("show-akreditasi/$akreditasi->id_akreditasi")); ?>" class="btn btn-info"><span
                                        class="fa fa-info"></span> Lihat</a>

                                <a href="<?php echo e(url("edit-akreditasi/$akreditasi->id_akreditasi")); ?>" class="btn btn-warning"><span
                                        class="fa fa-edit"></span> Edit</a>

                                <a href="<?php echo e(url("delete-akreditasi/$akreditasi->id_akreditasi")); ?>" class="btn btn-danger"><span
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                ...
                                <label class="custom-file-label">File Akreditasi</label>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\informatika\system\resources\views/admin/akreditasi/index.blade.php ENDPATH**/ ?>
            ...
            <div class="primary-menu">
                <div class="site-branding">
                    <a href="index.html" class="brand-logo"><img
                            src="<?php echo e(url('public/web')); ?>/assets/images/logo/ketapang.png" alt="Site Logo"></a>
                </div>
                        ...
                        <nav class="main-menu">
                            <ul>
                                <li><a href="<?php echo e(url('/')); ?>"
                                        class="nav-link <?php echo e(checkRouteActive('/')); ?>">Dashboard</a></li>
                                <li class="menu-item has-children"><a href="#">Assets</a>
                                    <?php echo $__env->yieldContent('menu'); ?>
                                </li>
                                <li><a href="<?php echo e(url('contact')); ?>"
                                        class="nav-link <?php echo e(checkRouteActive('contact')); ?>">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
...
<?php /**PATH D:\Github\sibamida\system\resources\views/components/section/web/header.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="<?php echo e(url("staff-administrasi/bangunan/delete-riwayat/$riwayat->id")); ?>"
                        ...
                        <div class="modal fade" id="modal-edit<?php echo e($riwayat->id); ?>">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="<?php echo e(url('staff-administrasi/bangunan/update-riwayat', $riwayat->id)); ?>"
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(url('staff-administrasi/bangunan/riwayat')); ?>" method="post"
    ...
    <script>
        ...
        card += "Nama Penanggungjawab: <?php echo e($bangunan->pegawai->jabatan); ?>\r\n";
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/bangunan/show.blade.php ENDPATH**/ ?>
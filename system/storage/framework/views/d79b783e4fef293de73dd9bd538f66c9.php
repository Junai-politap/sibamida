                                    ...
                                    <div class="modal fade" id="modal-edit<?php echo e($bidang->id); ?>">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(url('staff-administrasi/bidang', $bidang->id)); ?>" method="POST">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('staff-administrasi/bidang')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/bidang/index.blade.php ENDPATH**/ ?>
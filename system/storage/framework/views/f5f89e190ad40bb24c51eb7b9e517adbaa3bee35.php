                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tahun_masuk" value="<?php echo e($mahasiswa->tahun_masuk); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tahun_lulus" value="<?php echo e($mahasiswa->tahun_lulus); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="ipk" value="<?php echo e($mahasiswa->ipk); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/admin/mahasiswa/edit.blade.php ENDPATH**/ ?>
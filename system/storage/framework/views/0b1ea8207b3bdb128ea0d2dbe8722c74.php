...
<?php endif; ?>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('opd/master/tanah', $tanah->id)); ?>" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <img src="<?php echo e(url("public/$tanah->foto")); ?>" style="width: 100%">
                                                </div>
                                                <div class="col-md-6">
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/opd/tanah/edit.blade.php ENDPATH**/ ?>
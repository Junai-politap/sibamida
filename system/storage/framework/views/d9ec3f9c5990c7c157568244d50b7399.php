            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo e(url('admin/aset/create')); ?>" class="btn btn-primary float-right mb-10"> <span
                    ...
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $list_aset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <?php if (isset($component)) { $__componentOriginaldf05ec2d539ccc47939751d83314ef26 = $component; } ?>
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'admin/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'admin/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'admin/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                        ...
                                        <td class="text-left">
                                            <?php echo e($aset->kode_aset); ?>


                                        </td>
                                        <td class=""><?php echo e($aset->nama_aset); ?></td>
                                        <td class=""><?php echo e($aset->pegawai->nama); ?></td>
                                        <td>
                                            <?php echo e($aset->opd->nama_opd); ?>

                                            (<?php echo e($aset->ruangan->nama_ruangan); ?>)
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/admin/aset/index.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <section class="page-banner bg_cover position-relative z-1"
        ...
        <div class="brand-card text-center">
            ...
            <h3><?php echo e($jembatan->opd->singkatan); ?></h3>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="page-title">
                        <h1 class="cat-btn" style="font-size: 300%">Detail <?php echo e($jembatan->nama_aset); ?></h1>
                        <ul class="breadcrumbs-link">
                            <li><a href="<?php echo e(url('/')); ?>">Dashboard</a></li>
                            <li class="active"><a href="<?php echo e(url("jembatan/$jembatan->id_opd")); ?>"> Data Aset Jembatan dan
                                    Jalan </a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="blog-post-item">
                            ...
                            <div class="post-content">
                                <div class="entry-content" style="text-align: center">
                                    <p class="cat-btn"><?php echo e($jembatan->pegawai->nama); ?></p>
                                    <h3 class="title">
                                        <?php echo e($jembatan->nama_aset); ?>
                                    ...
                                    <div class="post-meta">
                                        <ul>
                                            <li>
                                                <span>
                                                    <i class="far fa-check"></i><?php echo e($jembatan->kategori->nama_kategori); ?>

                                                </span>
                                            </li>
                                            <li>
                                                <span>
                                                    <i class="far fa-check"></i><?php echo e($jembatan->kode_aset); ?>
                                                ...
                                                <table class="table" style="width: 100%">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> : <?php echo e($jembatan->panjang); ?> /
                                                                <?php echo e($jembatan->lebar); ?> /
...
</script><?php /**PATH D:\GitHub\sibamida\system\resources\views/web/show-jembatan.blade.php ENDPATH**/ ?>
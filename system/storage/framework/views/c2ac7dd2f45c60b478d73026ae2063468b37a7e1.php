...
<head>
    ...
    <link rel="icon" href="<?php echo e(url('admin')); ?>/logo.ico" type="image/x-icon">
    ...
    <link rel="stylesheet"
        href="<?php echo e(url('admin')); ?>//plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    <link rel="stylesheet"
        href="<?php echo e(url('admin')); ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">

    <link rel="stylesheet" href="<?php echo e(url('admin')); ?>/plugins/summernote/summernote-bs4.css">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <script src="<?php echo e(url('admin')); ?>/plugins/sweetalert2/sweetalert2.min.js"></script>
...
<?php /**PATH C:\laragon\www\informatika\resources\views/template/admin.blade.php ENDPATH**/ ?>
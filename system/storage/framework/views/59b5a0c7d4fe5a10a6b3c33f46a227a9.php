                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo e(url('opd/kategori/create')); ?>" class="btn btn-primary float-right mb-10"> <span
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'opd/kategori','id' => ''.e($kategori->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'opd/kategori','id' => ''.e($kategori->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH D:\Github\sibamida\system\resources\views/opd/kategori/index.blade.php ENDPATH**/ ?>
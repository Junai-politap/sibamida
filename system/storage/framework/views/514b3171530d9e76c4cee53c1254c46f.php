                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo e(url('opd/aset/create')); ?>" class="btn btn-primary float-right mb-10"> <span
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php if( Auth::guard('opd')->user()->id == $aset->id_opd): ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <?php if (isset($component)) { $__componentOriginaldf05ec2d539ccc47939751d83314ef26 = $component; } ?>
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'opd/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'opd/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'opd/aset','id' => ''.e($aset->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH D:\Github\sibamida\system\resources\views/opd/aset/index.blade.php ENDPATH**/ ?>
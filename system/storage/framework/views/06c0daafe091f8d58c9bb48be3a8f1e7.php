...
<?php endif; ?>
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="<?php echo e(url("admin/peralatan-mesin/delete-riwayat/$riwayat->id")); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="id_pegawai" class="form-control">
                                                            ...
                                                            <?php if($pegawai->id_opd == $peralatan->opd->id): ?>
                                                                <option
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(url('admin/peralatan-mesin/riwayat')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
    ...
    <script>
        ...
        card += "Kondisi: <?php if(isset($peralatan->kondisi->nama_kondisi )): ?><?php echo e($peralatan->kondisi->nama_kondisi); ?><?php else: ?> TIDAK ADA KONDISI <?php endif; ?>\r\n";
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/admin/peralatan-mesin/show.blade.php ENDPATH**/ ?>
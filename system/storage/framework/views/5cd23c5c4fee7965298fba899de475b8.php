...
<?php $component = App\View\Components\Button\BackButton::resolve(['url' => 'staff-administrasi/master/tanah'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <h3 class="text-center title">Edit Data Aset Tanah</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e(url('staff-administrasi/master/tanah', $tanah->id)); ?>" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_pegawai" class="form-control">
                                                ...
                                                <?php if( Auth::guard('staff')->user()->id_opd == $pegawai->id_opd): ?>
                                                    <option <?php if($pegawai->id == $tanah->id_pegawai): ?> selected <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_kategori">
                                                ...
                                                <?php if( Auth::guard('staff')->user()->id_opd == $kategori->id_opd): ?>
                                                    <option <?php if($kategori->id == $tanah->id_kategori): ?> selected <?php endif; ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode_barang"
                                                value="<?php echo e($tanah->kode_barang); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_barang"
                                                value="<?php echo e($tanah->nama_barang); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="register"
                                                value="<?php echo e($tanah->register); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="year" class="form-control" name="cara_perolehan"
                                                value="<?php echo e($tanah->cara_perolehan); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tahun_perolehan"
                                                value="<?php echo e($tanah->tahun_perolehan); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="keterangan"
                                                value="<?php echo e($tanah->keterangan); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="penggunaan"
                                                value="<?php echo e($tanah->penggunaan); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="no_sertifikat"
                                                value="<?php echo e($tanah->no_sertifikat); ?>">
                                        </div>
                                    </div>
...
<?php endif; ?>
<?php /**PATH E:\Sistem\sibamida\system\resources\views/staff-administrasi/tanah/edit.blade.php ENDPATH**/ ?>
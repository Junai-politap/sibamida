...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="index3.html" class="brand-link">
        <img src="<?php echo e(url("public", Auth::guard('staff')->user()->foto)); ?>"
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo e(url("public", Auth::guard('staff')->user()->foto)); ?>" class="img-circle elevation-2">
            </div>
            <div class="info">
...
<?php /**PATH E:\Sistem\sibamida\system\resources\views/components/section/staff/sidebar.blade.php ENDPATH**/ ?>
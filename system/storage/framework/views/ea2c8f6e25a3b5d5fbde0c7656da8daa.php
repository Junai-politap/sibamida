            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo e(url('admin/master/tanah/create')); ?>" class="btn btn-primary float-right mb-10"> <span
...
<?php $component = App\View\Components\Button\InfoButton::resolve(['url' => 'admin/master/tanah','id' => ''.e($tanah->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\EditButton::resolve(['url' => 'admin/master/tanah','id' => ''.e($tanah->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button\DeleteButton::resolve(['url' => 'admin/master/tanah','id' => ''.e($tanah->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH D:\GitHub\sibamida\system\resources\views/admin/tanah/index.blade.php ENDPATH**/ ?>
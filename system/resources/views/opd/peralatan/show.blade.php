<x-opd>
                        ...
                        <div class="modal fade" id="modal-edit{{ $riwayat->id }}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ url('admin/kategori', $riwayat->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        card +=
            "Nama Ruangan: @isset($peralatan->ruangan->nama_ruangan){{ $peralatan->ruangan->nama_ruangan }}@else TIDAK ADA RUANGAN @endisset\r\n";

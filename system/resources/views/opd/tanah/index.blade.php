                                ...
                                @if ( Auth::guard('opd')->user()->id == $tanah->id_opd)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <x-button.info-button url="opd/master/tanah" id="{{ $tanah->id }}" />
                                                <x-button.edit-button url="opd/master/tanah" id="{{ $tanah->id }}" />
                                                <x-button.delete-button url="opd/master/tanah" id="{{ $tanah->id }}" />
                                            </div>
                                        </td>
                                        <td class="text-left">
                                            {{ $tanah->kode_barang }}

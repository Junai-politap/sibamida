        ...
        <div class="row">
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="{{ url("opd/tanah/delete-riwayat/$riwayat->id") }}"
                        ...
                        <div class="modal fade" id="modal-edit{{ $riwayat->id }}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ url('opd/tanah/update-riwayat', $riwayat->id) }}" method="POST">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('opd/tanah/riwayat') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                {!! QrCode::size(200)->generate('{{ $bangunan->kode_aset }}') !!}
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="{{ url("opd/bangunan/delete-riwayat/$riwayat->id") }}"
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('opd/bangunan/riwayat') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="{{ url('opd/master/jembatan-jalan') }}" class="small-box-footer">More info <i
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="{{ url('opd/master/peralatan-mesin') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="{{ url('opd/master/bangunan') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="{{ url('opd/master/tanah') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>

                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ url("staff-administrasi/ruangan/delete/$ruangan->id") }}"
                                    ...
                                    <div class="modal fade" id="modal-edit{{ $ruangan->id }}">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('staff-administrasi/ruangan', $ruangan->id) }}" method="POST">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('staff-administrasi/ruangan') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf
                        <div class="card-body">
                            <input type="text" name="id_opd" value="{{ Auth::guard('staff')->user()->id_opd }}" hidden>

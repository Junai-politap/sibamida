<x-staff>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="text-center title">Info Aset</h3>
                                ...
                                <table class="table">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td> : {{ $jembatan->pegawai->jabatan }}</td>
                                        </tr>
            ...
            <div class="col-md-6">
                                ...
                                <div class="card-header">
                                    <div class="btn-group float-right">
                                        ...
                                        <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                            href="{{ url("staff-administrasi/jembatan-jalan/delete-riwayat/$riwayat->id") }}"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Edit Data Riwayat</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form action="{{ url('staff-administrasi/jembatan-jalan/update-riwayat', $riwayat->id) }}"
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('staff-administrasi/jembatan-jalan/riwayat') }}" method="post"
    ...
    <script>
        ...
        card += "Nama Penanggungjawab: {{ $jembatan->pegawai->jabatan }}\r\n";
        card +=

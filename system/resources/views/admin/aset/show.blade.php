            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <x-button.back-button url="admin/aset" />
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                {!! QrCode::size(250)->generate('{{ $aset->kode_aset }}') !!}
                               
                            </div>
                        </div>
                        
                        <ul class="ml-0 fa-ul text-muted" style="margin-top: 2%">
                            <h3> Nama Assets : {{ $aset->nama_aset }}</h3>
                            <h3> Kode Assets : {{ $aset->kode_aset }}</h3>
                            <h3> Kategori Assets : {{ $aset->kategori->nama_kategori }}</h3>
                            <h3> Lokasi Assets : {{ $aset->ruangan->nama_ruangan }}</h3>
                        </ul>
                    </div>
                ...
                <div class="card card-info">
                    ...
                    @foreach ($riwayat as $riwayat)
                        <div class="card-body p-0">
                            <a href="{{ url("opd/delete-riwayat/$riwayat->id") }}" class="btn btn-danger"><i

        ...
        <section class="choosing-area">
            <div class="container">
                <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
                    <?php $__currentLoopData = $list_penelitian->groupBy('tahun'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <?php $__currentLoopData = $list_penelitian->groupBy('tahun'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun => $list_penelitian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-info" data-toggle="modal"
                                                            data-target="#modal-lg<?php echo e($penelitian->id); ?>">
                                                            <span class="fa fa-info"></span>
                                                        </button>
                                                    </td>
                                                    <div class="modal fade" id="modal-lg<?php echo e($penelitian->id); ?>">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <label class="col-form-label">
                                                                                    : <?php echo e($penelitian->ketua); ?></label>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <label class="col-form-label">
                                                                                    :
                                                                                    <?php echo e($penelitian->anggota_dosen); ?></label>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <label class="col-form-label">
                                                                                    :
                                                                                    <?php echo e($penelitian->anggota_mahasiswa); ?></label>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <label class="col-form-label">
                                                                                    : <?php echo e($penelitian->skema); ?></label>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/home/project/penelitian.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('fasilitas'); ?>
    <?php $__currentLoopData = $list_jenis_fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li><a href="<?php echo e(url("fasilitas/$jenis_fasilitas->id")); ?>"><?php echo e($jenis_fasilitas->nama); ?></a></li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopSection(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/section/menu.blade.php ENDPATH**/ ?>
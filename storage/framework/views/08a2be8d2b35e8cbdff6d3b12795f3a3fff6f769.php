                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="jenis_fasilitas" class="form-control">
                                    <option value="Workspace" <?php if($fasilitas->jenis_fasilitas == 'Workspace'): ?> selected <?php endif; ?>>Workspace
                                    </option>
                                    <option value="Research and Development" <?php if($fasilitas->jenis_fasilitas == 'Research and Development'): ?> selected <?php endif; ?>>Research and Development
                                    </option>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/admin/fasilitas/edit.blade.php ENDPATH**/ ?>
        ...
        <div class="card-body">
            <form id="form" data-parsley-validate="" action="<?php echo e(url('update-berita', $berita->id)); ?>" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-10">
                        <input type="date" class="form-control" name="tanggal_kegiatan" value="<?php echo e($berita->tanggal_kegiatan); ?>">
                    </div>
                </div>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/admin/berita/edit.blade.php ENDPATH**/ ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="card">
                                        <img src="<?php echo e(url("public/$pegawai->foto")); ?>" class="card-img-top" alt="Waterfall"
                                            style="object-fit: cover; position: static; width: 130%; height: 500px;">
                                        <div class="card-body">
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\informatika\system\resources\views/home/profil/staff.blade.php ENDPATH**/ ?>
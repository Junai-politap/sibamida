                        ...
                        <div class="widget"><br>
                            <header class="widget-header"><br>
                                <h4 class="widget-title">
                                    <?php $__currentLoopData = $list_bagian->where('id', '96ae2407-65d2-4c4f-b204-77b435bd5f4c'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bagian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="container">
                                <form action="<?php echo e(url('store-form-III')); ?>" method="post">
                                    <input name="id_mahasiswa" value="<?php echo e($mahasiswa->id); ?>" type="hidden">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = $list_soal->where('id_bagian', '96ae2407-65d2-4c4f-b204-77b435bd5f4c'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('template.mahasiswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/mahasiswa/tracer-study-form-iii.blade.php ENDPATH**/ ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $list_mahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')"
                                        href="<?php echo e(url("delete-mahasiswa/$mahasiswa->id")); ?>" class="btn btn-danger"><span
                            ...
                            <td class="text-center">
                                Tahun Masuk : <?php echo e($mahasiswa->tahun_masuk); ?> <br>
                                Tahun Lulus :<?php echo e($mahasiswa->tahun_lulus); ?>

                            </td>
                            <td class="text-center"><?php echo e($mahasiswa->ipk); ?></td>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/admin/mahasiswa/index.blade.php ENDPATH**/ ?>
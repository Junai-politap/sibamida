    ...
    <section class="choosing-area"> 
        <div class="container">
            <div class="sec-title text-center">
                <div class="title"> Data <?php echo e($jenis_fasilitas->nama); ?></div>
            ...
            <div class="row">
                ...
                <?php if($fasilitas->id_jenis_fasilitas == $jenis_fasilitas->id): ?>
                    <a href="<?php echo e(url("detail-fasilitas/$fasilitas->id")); ?>">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <div class="single-choosing-item">
                                ...
                                <div class="text-holder">
                                    ...
                                    <a class="readmore" href="<?php echo e(url("detail-fasilitas/$fasilitas->id")); ?>">Detail</a>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="approach-content-box">
                <div class="sec-title">
                    <h2>Detail <?php echo e($jenis_fasilitas->nama); ?></h2>
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/www/teknologiinformasi/system/resources/views/home/fasilitas/fasilitas.blade.php ENDPATH**/ ?>
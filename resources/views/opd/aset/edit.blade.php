            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('opd/aset', $aset->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $aset->kode_aset }}"
                                                name="kode_aset">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_kategori">
                                                ...
                                                @foreach ($kategori as $kategori)
                                                    <option @if ($kategori->id == $aset->id_kategori) selected @endif
                                                        value="{{ $kategori->id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_ruangan">
                                                ...
                                                @foreach ($ruangan as $ruangan)
                                                    <option @if ($ruangan->id == $aset->id_ruangan) selected @endif
                                                        value="{{ $ruangan->id }}">
